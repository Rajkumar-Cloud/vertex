                        ...
                        <div class="container">
                            <div class="c-wapp d-flex justify-content-between">
                                ...
                                <div class="button-box d-flex justify-content-end align-items-center">
                                    <div>
                                        <a href="contact.php" class="mt-30 effect-ajax dsn-button p-relative">
                        ...
                        <div class="footer-container">
                            <div class="d-flex align-items-center h-100">
                                ...
                                <div class="column-right">
                                    <h5>2022 © Copyright, All rights reserved<span class="love">♥</span>by
                                        <a class="link-hover" data-hover-text="Vertex." target="_blank" rel="nofollow" href="#">Vertex.</a>
                                    </h5>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="input__wrap controls">
                                        ...
                                        <div class="form-group">
                                            <div class="entry-box">
                                                ...
                                                <input id="form_mobile" type="number" name="mobile_no" placeholder="Type your mobile no" required="required" data-error="Valid mobile no is required." />
                                            </div>
                                            <div class="help-block with-errors"></div>
                                        </div>
