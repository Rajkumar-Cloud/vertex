                  ...
                  <div class="slide-content p-absolute ">
                     <div class="content p-relative">
                        ...
                        <h1 class="title user-no-selection d-inline-block ">
                           <a href="services.php" class="effect-ajax"
                              data-dsn-ajax="slider">Network Collaboration </a>
                        </h1>
                        <hr class="mt-20" />
                        <p class="max-w570 mt-20 description">Company relies on information systems to perform its day-to-day functions.</p>
                     </div>
                  </div>
               </div>
               <div class="slide-item swiper-slide over-hidden">
                  ...
                  <div class="slide-content p-absolute  ">
                     <div class="content p-relative">
                        ...
                        <h1 class="title user-no-selection d-inline-block ">
                           <a href="services.php" class="effect-ajax"
                              data-dsn-ajax="slider">Proactive data protection</a>
                        </h1>
                        <hr class="mt-20" />
                        <p class="max-w570 mt-20 description">provide managed backup services, so you’ll know your data is in safe hands.</p>
                     </div>
                  </div>
               </div>
               <div class="slide-item swiper-slide over-hidden">
                  ...
                  <div class="slide-content p-absolute  ">
                     <div class="content p-relative">
                        ...
                        <div class="d-block"></div>
                        <h1 class="title user-no-selection d-inline-block ">
                           <a href="services.php" class="effect-ajax" data-dsn-ajax="slider">Managed Services</a>
                        </h1>
                        <hr class="mt-20" />
                        <p class="max-w570 mt-20 description">Business growth and Technology adoption strategies for your industry.</p>
                     </div>
                  </div>
               </div>
               <div class="slide-item swiper-slide over-hidden">
                  ...
                  <div class="slide-content p-absolute  ">
                     <div class="content p-relative">
                        ...
                        <h1 class="title user-no-selection d-inline-block ">
                           <a href="services.php" class="effect-ajax"
                              data-dsn-ajax="slider">Robotic process automation</a>
                        </h1>
                        <hr class="mt-20" />
                        <p class="max-w570 mt-20 description">Advanced technology is a valuable asset to growing companies of all sizes.</p>
                     </div>
                  </div>
               </div>
               <div class="slide-item swiper-slide over-hidden">
                  ...
                  <div class="slide-content p-absolute  ">
                     <div class="content p-relative">
                        ...
                        <h1 class="title user-no-selection d-inline-block ">
                           <a href="services.php" class="effect-ajax"
                              data-dsn-ajax="slider">Data Protection</a>
                        </h1>
                        <hr class="mt-20" />
                        <p class="max-w570 mt-20 description ">Huggl is an induction
                           charging.
                        </p>
                     </div>
                  </div>
               ...
               <div class="slide-item swiper-slide over-hidden">
                  ...
                  <div class="slide-content p-absolute  ">
                     <div class="content p-relative">
                        ...
                        <h1 class="title user-no-selection d-inline-block ">
                           <a href="services.php" class="effect-ajax"
                              data-dsn-ajax="slider">Technology Revolution</a>
                        </h1>
                        <hr class="mt-20" />
            ...
            <div class="box-info pt-60 pb-60">
               <div class="title-move z-index-1 " data-dsn-grid="move-section"
                  ...
                  <h2 class="section-title mb-30 dsn-text-shadow text-transform-upper">
                     Business Stratergy, <br /> Design Grid
                  </h2>
               </div>
               ...
               <p class="max-w570 dsn-up mb-10 ">
                  We understand your business and consult on value creation using technology. Global organizations or small and medium enterprises, we get your dynamics and can accelerate your journey to success.
               </p>
         ...
         <div class="col-lg-6">
            <div class="box-right">
               <p class="max-w570 dsn-up mb-15 ">
                  Vertex, a 1-Stop full range of systems integration and end to end digital solution, communication and software development solution for SME and larger enterprise. Our skilled engineers are well trained to perform complex integration. 
               </p>
               <p class="max-w570 dsn-up">
                  We are committed to achieve our corporate mission by providing wide range of services and help your company to reduce total cost of ownership. Our innovative and ‘think out-of-box’ DNA brings great value and productivity improvement, adopting Game Change approach for business transformation. Vision <br> Transforming our client’s business using our intellectual, game change approach
               </p>
               <br />
               <h6>VISION</h6>
               <p class="max-w570 dsn-up">Transforming our client’s business using our intellectual, game change approach.</p>
               <h6>MISSION</h6>
               <p class="max-w570 dsn-up">Dependable, Service-Oriented, as your technology partner. Our partnership with suppliers and clients are set to the highest level at all time. We recommend best practices and expert advice to meet your business requirements and growth. </p>
            </div>
         </div>
         <!-- <div class="col-12">
            <div class="box-bottom pt-50 border-top mt-50">
                <div class="d-grid d-grid-no-space grid-md-3 grid-sm-1">
                    <div class="item d-flex align-items-center">
                        ...
                        <h4 class="title-block ml-15">Dependable</h4>
                    </div>
                    ...
                    <div class="item d-flex align-items-center">
                        <i class="fas fa-check theme-color"></i>
                        <h4 class="title-block ml-15">Service Oriented</h4>
                    </div>
                </div>
            </div>
            </div> -->
...
<section class="services with-line with-number p-relative section-margin dsn-col"
   ...
   <div class="container mb-70 d-flex text-center flex-column align-items-center">
      ...
      <h2 class="section-title  title-cap">We are delivering beautiful <br> digital products for you.</h2>
   </div>
   <div class="container">
            ...
            <div class="services-item-inner">
               ...
               <div class="services-content background-section">
                  ...
                  <div class="service-description">
                     <h4 class="title-block mb-15">System Integration</h4>                     
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
            <div class="services-item-inner">
               ...
               <div class="services-content background-section">
                  ...
                  <div class="service-description">
                     <h4 class="title-block mb-15">Data Storage and Security</h4>                     
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
            <div class="services-item-inner">
               ...
               <div class="services-content background-section">
                  ...
                  <div class="service-description">
                     <h4 class="title-block mb-15">Telecommunications</h4>                     
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
            <div class="services-item-inner">
               ...
               <div class="services-content background-section">
                  ...
                  <div class="service-description">
                     <h4 class="title-block mb-15">Systems and Networking</h4>                     
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
            <div class="services-item-inner">
               ...
               <div class="services-content background-section">
                  ...
                  <div class="service-description">
                     <h4 class="title-block mb-15">Data Center Infrastructure</h4>                     
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
            <div class="services-item-inner">
               ...
               <div class="services-content background-section">
                  ...
                  <div class="service-description">
                     <h4 class="title-block mb-15">Software solutions</h4>                     
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
            <div class="services-item-inner">
               ...
               <div class="services-content background-section">
                  ...
                  <div class="service-description">
                     <h4 class="title-block mb-15">Managed security and services</h4>                     
                  </div>
               </div>
            </div>
         </div>
         <div class="col-md-6 col-lg-4 dsn-col-lg-3 dsn-col-md-2 dsn-col-sm-1 services-item grid-item dsn-up">
            <div class="services-item-inner">
               ...
               <div class="services-content background-section">
                  ...
                  <div class="service-description">
                     <h4 class="title-block mb-15">Help Desk and Call Center Services</h4>                     
                  </div>
               </div>
            </div>
         </div>
...
<div class="box-seat box-seat-parallax section-margin">
   ...
   <div class="pro-text background-section box-padding" data-dsn-grid="move-section"
      ...
      <p>
         ...
         his
         bottle pear shaped bugger all mate
      </p>
...
<section class="brand-client section-margin" data-dsn-animate="section" data-dsn-title="our clients">
   <div class="container mb-70 d-flex text-center flex-column  align-items-center">
      ...
      <h2 class="section-title  title-cap">
         Our successful, delight <br />services
      </h2>
   </div>
   <div class="container">
            ...
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                <div class="box-meta">
                    <div class="entry-date">
                        ...
                        <a href="#" class="effect-ajax"></a>
                    </div>
                </div>
                <div class="box-img over-hidden">
                    <img class="cover-bg-img" src="assets/img/blog/1.jpg" alt="">
                </div>
                <div class="box-content p-relative">
                    <div class="box-content-body">                        
                        <h4 class="title-block mb-20">
                            <a href="#" class="effect-ajax">System Integration</a>
                        </h4>
                        <p>Vertex offers services in undertaking Information Technology networking systems integration projects in the Emirates and the Gulf Region. We can provide complete and comprehensive systems solutions that fit customer requirements and budget.
                            Through our proven methodologies, we can develop, design, and deploy leading edge, reliable solutions for the IT requirements of our clients in the Emirates and the Gulf Region. We can ensure that our client’s proposed IT infrastructure will be ready today for tomorrow’s applications and business requirements. We have the resources and capability to design, install, configure, and commission and support a broad range of ITC services including but not limited to.</p>
                        <!-- <a href="#" class="effect-ajax link-vist p-relative mt-20">
        ...
        <div class="dsn-posts d-grid grid-lg-1">
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                ...
                <div class="box-img over-hidden">
                    <img class="cover-bg-img" src="assets/img/blog/2.jpg" alt="">
                </div>
                <div class="box-content p-relative">
                    <div class="box-content-body">                        
                        <h4 class="title-block mb-20">
                            <a href="#" class="effect-ajax">Data Storage and Security</a>
                        </h4>
                        <p>&#8226; An effective storage solution is a huge contributor to an efficient workday. Dealing with slow response times is a huge contributor to frustration and lost productivity. Building a storage solution that’s efficient for end users and meets the cost pressures of your budget requires some careful planning.</p>
                        <p>&#8226; Our experts can help analyse your requirements and design a solution that delivers consistent, high performance for your business.</p>
                        <p>&#8226; Our data solutions are bulletproof. Technical excellence is nonnegotiable for us, providing physical security, infrastructure redundancy and operational efficiency within our data center grid. We deliver high availability for mission critical environments, whilst protecting your IP and information. Data security is our number one priority.</p>
                    </div>
                </div>
            </div>            
        </div>
        ...
        <div class="dsn-posts d-grid grid-lg-1">
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                ...
                <div class="box-img over-hidden">
                    <img class="cover-bg-img" src="assets/img/blog/3.jpg" alt="">
                </div>
                <div class="box-content p-relative">
                    <div class="box-content-body">                        
                        <h4 class="title-block mb-20">
                            <a href="#" class="effect-ajax">Telecommunication & App. Development</a>
                        </h4>
                        <p>&#8226; Vertex has made its mark not just in the UAE but in the entire Middle East as a leading provider of Telecom solutions.</p>
                        <p>&#8226; The trusted solutions from the company include solutions for Monitoring, Stress Testing, Customer Experience Management (QoE), Roaming & Interconnect, Revenue Assurance, Business Intelligence, OSS/BSS, DMS, Disaster Recovery Automation, GIS and Contact Centers.</p>
                        <p>&#8226; Vertex has extensive experience in creating high performance, feature-packed and digitally transformative native Smartphone applications for all the major mobile platforms including iOS, Android.</p>
                        <p>&#8226; We are rapidly expanding our design and development services to leverage applications in Retail, F&B, and Services Industry. Our team is experienced in creating solutions for a wide range of platforms. We offer specialized packages to satisfy a range of needs and budgets, from rapid prototyping for startups to full-featured interfaces for international enterprises. </p>
                    </div>
                </div>
            </div>            
        </div>
        ...
        <div class="dsn-posts d-grid grid-lg-1">
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                ...
                <div class="box-img over-hidden">
                    <img class="cover-bg-img" src="assets/img/blog/4.jpg" alt="">
                </div>
                <div class="box-content p-relative">
                    <div class="box-content-body">                        
                        <h4 class="title-block mb-20">
                            <a href="#" class="effect-ajax">Systems and Networking</a>
                        </h4>
                        <p>&#8226; Your office network provides vital connectivity between your computers, phones, servers, wireless access and the outside world.</p>
                        <p>&#8226; Getting the design and/or implementation of this wrong can have far reaching consequences, resulting in poor performance, loss of internet, Wi-Fi black spots or dropped phone calls.</p>
        ...
        <div class="dsn-posts d-grid grid-lg-1">
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                ...
                <div class="box-img over-hidden">
                    <img class="cover-bg-img" src="assets/img/blog/5.jpg" alt="">
                </div>
                <div class="box-content p-relative">
                    <div class="box-content-body">                        
                        <h4 class="title-block mb-20">
                            <a href="#" class="effect-ajax">Data Center Infrastructure</a>
                        </h4>
                        <p>&#8226; Data center infrastructure refers to the components that make up a data center’s physical infrastructure — networking equipment, storage devices, and switches, to name a few.</p>
                        <p>&#8226; These provide the processing power that organizations need to run their applications and manage their IT operations.</p>
                        <p>&#8226; Data center infrastructure also includes equipment that supports those core components. To keep servers from overheating and shutting down, data centers deploy cooling systems and other environmental controls.</p>
                    </div>
                </div>
            </div>            
        </div>
        ...
        <div class="dsn-posts d-grid grid-lg-1">
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                ...
                <div class="box-img over-hidden">
                    <img class="cover-bg-img" src="assets/img/blog/6.jpg" alt="">
                </div>
                <div class="box-content p-relative">
                    <div class="box-content-body">                        
                        <h4 class="title-block mb-20">
                            <a href="#" class="effect-ajax">Software Solutions</a>
                        </h4>
                        <p>&#8226; Vertex offers business software solution that help organization record micro information with ease.</p>
                        <p>&#8226; Vertex software division is focused on integrating applications with the existing ERP system of customers to seamlessly monitor staff performance, track telephone usage by the employees, staff login and log-off times, employee details, finances and more in a user-friendly manner. Vertex sincerely works towards improving and uplifting the existing business work process of customers. This mission is fully backed by the highly talented and professional team of engineers and designers who understand the core intentions behind this mission.</p>                        
                    </div>
                </div>
            </div>            
        </div>
        ...
        <div class="dsn-posts d-grid grid-lg-1">
            <div class=" blog-item p-relative d-flex align-items-center h-100 w-100" data-swiper-parallax-scale="0.85">
                ...
                <div class="box-img over-hidden">
                    <img class="cover-bg-img" src="assets/img/blog/7.jpg" alt="">
                </div>
                <div class="box-content p-relative">
                    <div class="box-content-body">                        
                        <h4 class="title-block mb-20">
                            <a href="#" class="effect-ajax">Support Services</a>
                        </h4>
                        <p>&#8226; We offer an extensive range of services, from installation and upgrades to maintenance and emergency repairs. Safety is our number one priority. We work safely and strive to create a safe environment for every client. We never cut corners or take shortcuts. Your satisfaction is our only priority.</p>
                        <p>&#8226; With our fully managed support services, we go beyond the expectations of the average support package. More than just someone on the ground. Alongside support received from our trained onsite support staff, we have a wide-ranging support structure. To ensure that when you need us, we are there 24/7..</p>                        
                    </div>
                </div>
            </div>            
        </div>
