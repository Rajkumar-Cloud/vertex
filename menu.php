                ...
                <div class="container-content  p-absolute h-100 left-60 d-flex flex-column justify-content-center">
                    <div class="nav__info">
                        <div class="nav-content">
                            <p class="title-line">Vertex</p>
                            <p>Office 331, Schon Bussiness Park, <br>Dubai Investment Park(DIP), Dubai</p>
                        </div>
                        <div class="nav-content">
                            <p class="title-line">
                                Contact</p>
                            <p class="links over-hidden">
                                <a href="tel:+971 50 5603188" data-hover-text="+971 50 5603188" class="link-hover">+971 50 5603188</a>
                            </p>
                            <p class="links  over-hidden">
                                <a href="#" data-hover-text="waris@vertexinfo.com" class="link-hover">waris@vertexinfo.ae</a>
                            </p>
                        </div>
                    </div>
